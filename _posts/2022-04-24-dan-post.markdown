...
header:
  ...
  # Teaser images should be at lower resolutions (i.e, ~250*150) compressed `.jpg` format
  # teaser: /assets/images/logo_no_text.png
  # Caption is rendered in the bottom-right corner of the image
  # caption: "Photo credit: [**Unsplash**](https://unsplash.com)"
---
![My helpful screenshot](/assets/images/logo_no_text.png)
