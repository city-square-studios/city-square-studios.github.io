...
The main games that inspired me were Get Bit! (Dave Chalker, 2007), Poker, and Liar's Dice.
...
## Availability
52 Pickup is currently only available upon request (by emailing hello@citysquarestudios.com) or physically at markets we attend. We are currently working on making 52 Pickup more easily accessible both online and physically.
